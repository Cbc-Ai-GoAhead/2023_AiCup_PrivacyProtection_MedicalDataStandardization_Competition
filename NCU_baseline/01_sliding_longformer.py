...
if __name__ == '__main__':
  ...
  writer = SummaryWriter(comment='slidingwindow_longformer')
  ...
  for epoch in range(EPOCH):
    ...
    output_dir = "./model_slidingwindow_clip_4096_1024/" + "longformer"+"_"+str(epoch)+"_"+str(BACH_SIZE)+"_"+str(sum_val_F1/len(val_dataloader))
